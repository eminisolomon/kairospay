# This code is developed by Solomon Olatunji.
# Software Developer and DevOps Engineer
# Email: aotoluwalopen@gmail.com
...
class Monnify:
    ...
    def tranfer(self, credentials, amount, reference, narration, bankCode, accountNumber):
        ...
        if live == True or live == False:
            ...
            response = requests.request("POST", url, auth=HTTPBasicAuth(
                username, password), headers=headers, data=json.dumps(payload))
    ...
    def get_transfer_details(self, credentials, reference):
        ...
        if live == True or live == False:
            ...
            response = requests.request("GET", url, auth=HTTPBasicAuth(
                username, password), headers=headers, data=json.dumps(payload))
    ...
    def create_sub_account(self, credentials, bankCode, accountNumber, email, splitPercentage):
        ...
        if live == True or live == False:
            ...
            response = requests.request("POST", url, auth=HTTPBasicAuth(
                username, password), headers=headers, data=payload)
    ...
    def update_sub_account(self, credentials, subAccountCode, bankCode, accountNumber, email, splitPercentage):
        ...
        if live == True or live == False:
            ...
            response = requests.request("PUT", url, auth=HTTPBasicAuth(
                username, password), headers=headers, data=json.dumps(payload))
    ...
    def delete_sub_account(self, credentials, subAccountCode):
        ...
        if live == True or live == False:
            ...
            response = requests.request("DELETE", url, auth=HTTPBasicAuth(
                username, password), headers=headers, data=json.dumps(payload))
