...
class PaymentAPI(BaseAPI):
    ...
    def create_payment(
        ...
        :param ipn_callback_url:  url to receive callbacks, should contain "http/https",  e.g: "https://kairospays.io"
        :param order_id: inner store order ID, e.g. "RGDBP-21314"
        :param kwargs: Keyword arguments. See: https://documenter.getpostman.com/view/7907941/S1a32n38?version=latest
        :return: Payment.
        :rtype: dict
        """
        data = {
